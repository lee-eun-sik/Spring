...
import service.file.newsboardFileService;
import service.file.newsboardFileServiceImpl;


@WebServlet("/newsboardfile/*")
@MultipartConfig(
...
public class newsboardFileController extends HttpServlet {
	...
	private static final Logger logger = LogManager.getLogger(newsboardFileController.class); 
	private newsboardFileService newsboardFileService;
	
	public newsboardFileController() {
	        super();
	        newsboardFileService = new newsboardFileServiceImpl();
	    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  logger.info("FileController doGet"); 
	      ...
	      if ("/newsboardfile/down.do".equals(path)) {
	    	  int fileId = Integer.parseInt(request.getParameter("fileId"));
	    	  PostFile file= new PostFile();
	    	  file.setFileId(fileId);
	    	  
	    	  PostFile selectFile = newsboardFileService.getFileByFileId(file);
	      ...
	      } else if ("/newsboardfile/imgDown.do".equals(path)) {
	    	  int fileId = Integer.parseInt(request.getParameter("fileId"));
	    	  PostFile file= new PostFile();
	    	  file.setFileId(fileId);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {
	        ...
	        if ("/newsboardfile/imgUpload.do".equals(path)) { 
	        	HashMap resultMap = newsboardFileService.insertBoardFiles(request);
	            ...
	            if(isUploadFile) {
	            	jsonResponse.put("url", "/newsboardfile/imgDown.do?fileId="+ resultMap.get("fileId"));
	            }
	        }
